...
[![Build Status](https://travis-ci.org/imttx/hystrix-go.png?branch=master)](https://travis-ci.org/imttx/hystrix-go)
[![GoDoc Documentation](http://godoc.org/github.com/imttx/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/imttx/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/imttx/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/imttx/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/imttx/hystrix-go```
- ```go test ./...```
